def Closed_Logarithmic_Nyquist(sys, n):
    '''
...
# %**************************************************************************
def function f = arrowc(x0, y0, x, y, rx, ry);
# Plots an arrow at (x,y) along vector dx=x-x0, dy=y-y0. 
# The length of the arrow is rx and ry in the directions x and y. 
# The arrow color is c.
